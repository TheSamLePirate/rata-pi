...
use cards::{bash_card, compaction_lines, plain_paragraph, retry_lines, thinking_body, tool_card};
use draw::{draw, draw_scrollbar};
use helpers::{approx_tokens, extract_error_detail, on_off, truncate_preview};
use modals::bodies::{
    command_detail_lines, commands_selected_line, commands_text, diff_body_lines, doctor_body,
    doctor_checks, ext_confirm_text, ext_input_text, ext_select_text, file_finder_text,
    file_preview_lines, forks_text, git_branch_body, git_log_body, git_status_body, help_text,
    history_text, mcp_body, mcp_rows, models_text, plan_card, plan_full_lines, plan_review_body,
...
use crate::ui::transcript::{BashExec, Entry, Transcript};
